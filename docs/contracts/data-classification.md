...
| `updated_at` | `TIMESTAMPTZ NOT NULL DEFAULT NOW()` | P0 | No | Yes | Non-sensitive timestamp — stamped on every registration and every rotation. The 24-hour sweep's predicate |
