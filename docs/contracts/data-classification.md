...
|------|-------|-------------|
| P0 | 135 | Public — timestamps, opaque IDs, aggregate stats, feature flags, enums, authorization tiers, notification-delivery preferences |
