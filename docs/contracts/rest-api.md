...
7. Endpoint reference
   ...
   21. Live Activity token registration (2 operations — MYR-172; content-state progress track — MYR-398; the lifecycle banner defers to the island — MYR-413; the sixth island expansion rides an update, not the end — MYR-418)
