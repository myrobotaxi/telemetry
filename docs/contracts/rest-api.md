...
Errors: `401 auth_failed`, `403 permission_denied` (rider/non-owner party), `404 not_found` (unknown id / non-party), `409 conflict` (illegal lifecycle transition), `409 vehicle_unavailable` (target vehicle `in_service`/`offline`, MYR-277), `500 internal_error`.
