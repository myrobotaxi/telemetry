...
The four `POST`/`GET /api/ride-requests[...]` rows (§7.8) are the rider-facing surface mounted by the Go server as of MYR-174; the owner-facing incoming feed + accept/decline are added by MYR-175.
